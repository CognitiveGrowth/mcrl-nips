...
jsPsych.plugins['graph'] = (function() {
  ...
  GraphMDP = (function() {
    function GraphMDP(config) {
      ...
      var lowerMessage, ref, ref1, ref2, ref3, ref4;
      this.display = config.display, this.block = config.block, this.graph = config.graph, this.initialState = config.initialState, this.trialID = config.trialID, this.infoCost = (ref = config.infoCost) != null ? ref : 0.10, this.keys = (ref1 = config.keys) != null ? ref1 : KEYS, this.playerImage = (ref2 = config.playerImage) != null ? ref2 : '/static/images/plane.png', this.minTime = (ref3 = config.minTime) != null ? ref3 : (DEBUG ? 5 : 45), lowerMessage = (ref4 = config.lowerMessage) != null ? ref4 : KEY_DESCRIPTION;
