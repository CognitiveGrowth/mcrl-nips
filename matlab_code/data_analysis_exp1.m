cd ~/Desktop/Tom_Griffiths/mcrl-nips/matlab_code/
clear
%%

experiment_version = 'N2';

BLUE = [0,50,98]/255;
GOLD = [253,181,21]/255;
SAVE = false;
DO_STATS = false;
figdir = ['~/Dropbox/PhD/Metacognitive RL/mcrl-experiment/results_human/figures/',experiment_version,'/'];
...
idx0 = [data.condition]==5;
idx1 = [data.condition]==6;
idx2 = [data.condition]==7;
idx3 = [data.condition]==8;
